...
<!-- GLORY -->
    ...
    ?>
                ...
                if($dates3['total_transactions_glory'] > 0){ ?> 
                    <td style="font-size: 11px; font-weight: bold;"> <?php echo $dates3['total_transactions_glory']; $dateCount--;?></td>
                     <?php } }
                if($dateCount > 0){ ?>
                    <td style="font-size: 11px; font-weight: bold;">0 <?php echo $dateCount; $dateCount--; ?></td>
                     <?php 
                } 
                ?>  <td style="font-size: 11px; font-weight: bold;">0</td>
                    <td style="font-size: 11px; font-weight: bold;"><?php echo $foofoo ?> </td> <?php
                      ?>
