                ...
                if(isset($_POST['inputSubmit'])){
                    ...
                    if(mysqli_num_rows($result_emp) > 0){
                        ...
                        if(mysqli_num_rows($result_tran) > 0){
                            ...
                            $tran_insert = "INSERT INTO `tbl_trans_logs`(`transaction_id`, `emp_id`, `emp_name`, `emp_cardNum`, `employer`, `tran_date`, `tran_time`, `department`,`section`,`gpi8`,`pos`) VALUES (null ,'$empID','$empName','$empCardNum','$empEmployer','$dateNow','$timeNow', '$department','$section','$gpi8','1')";
...
// echo
        ...
        <div class="grid-item item2">
            ...
            <?php
                $dateNow = date("Y-m-d");
                $queryRT = "SELECT * FROM tbl_trans_logs WHERE tran_date = '$dateNow' AND pos = '1' ORDER BY transaction_id DESC LIMIT 8";
...
$query_maxim = "SELECT * FROM `tbl_trans_logs` WHERE employer = 'MAXIM' AND tran_date = '$dateNow' AND pos = '1'";
...
$query_nippi = "SELECT * FROM `tbl_trans_logs` WHERE employer = 'NIPPI' AND tran_date = '$dateNow' AND pos = '1'";
...
$query_pl = "SELECT * FROM `tbl_trans_logs` WHERE employer = 'POWERLANE' AND tran_date = '$dateNow' AND pos = '1'";
...
$query_sp = "SELECT * FROM `tbl_trans_logs` WHERE employer = 'SERVICE PROVIDER' AND tran_date = '$dateNow' AND pos = '1'";
